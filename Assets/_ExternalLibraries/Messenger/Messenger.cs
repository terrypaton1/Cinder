...
static internal class MessengerInternal {
    ...
    static public void OnListenerRemoving(string eventType, Delegate listenerBeingRemoved) {
        ...
        {
        	//Debug.Log(string.Format("Attempting to remove listener for type {0} but Messenger doesn't know about this event type.", eventType));
...
static public class Messenger {
	...
	static public void DumptTable()
	{
		
/*
		CKDebug.Log("Messenger Dump");
		foreach(KeyValuePair<String,Delegate> de in eventTable)
		{
			CKDebug.Log("Listener registered for :"+de.Key);
		}
		
		Messenger<int>.DumptTable2();
		Messenger<int,int>.DumptTable3();
		Messenger<int,int,int>.DumptTable4();
		CKDebug.Log("Messenger Dump Done");
		*/
	}
...
static public class Messenger<T> {
	...
	static public void DumptTable2()
	{
		
		//foreach(KeyValuePair<String,Delegate> de in eventTable)
		//{
			//Debug.Log("Listener registered for :"+de.Key);
		//}
	}
...
static public class Messenger<T, U> {
    private static Dictionary<string, Delegate> eventTable = MessengerInternal.eventTable;
	static public void DumptTable3()
	{
...
static public class Messenger<T, U, V> {
    private static Dictionary<string, Delegate> eventTable = MessengerInternal.eventTable;
	static public void DumptTable4()
	{
