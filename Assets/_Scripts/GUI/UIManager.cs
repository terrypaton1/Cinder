...
{
	[SerializeField]
	UIWidget screenMainMenu;

	[SerializeField]
	UIWidget screenCredits;
	...
	[SerializeField]
	UIWidget levelLoader;

	[SerializeField]
	UIWidget initialLoadScreen;

	[SerializeField]
	UIWidget SignoutOfSocialDialogHolder;
	...
	void DisplayLevelLoader (bool display)
	{
		levelLoader.gameObject.SetActive (display);		
	}

	void unloadGameIfOneIsLoaded ()
	{
...
//		SceneManager.UnloadScene("Game");
	...
	void DisplayUIScreen (UIScreens displayScreenID)
	{
//		Debug.Log("DisplayUIScreen:" + displayScreenID);
		Messenger<string,string>.Broadcast (GlobalEvents.AnalyticsEvent, BrickAnalytics.changeScene, displayScreenID.ToString ());
